...
@gcc -Wall -Wextra -O3 -o %path_comp%/diff.exe _o/main.o _o/init.o _o/params.o _o/paths.o _o/index.o _o/hash.o _o/diff.o _o/smatrix.o _o/print.o _o/err.o _o/_string.o lib/libregex.dll.a
@del _o /Q
@rmdir _o /q /s
